...
public class PuzzleGame extends javax.swing.JFrame {
    ...
    public PuzzleGame() {
        initComponents();
       //set clear button backgrunds
         button1.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         button2.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         button3.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         button4.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         button5.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         button6.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         button7.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         button8.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         button9.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         button10.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         button11.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         button12.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
         jPanel3.setBackground(new Color(255,235,205));
                jButton3.setVisible(false);
      
                //makes buttons inivisble at first
...
//adds to array
    ...
    //checks to see if allows a free solve
    ...
    //move function checks buttons near it 
    ...
    public void isSolved() {
        ...
        if (b1 == "1" && b2 == "2" && b3 == "3" && b4 == "4" && b5 == "5" && b6 == "6"
            ...
            allitalk.setText("NICE NOW LETS GET GOING!");
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(810, 360));
        ...
        jPanel3.setForeground(new java.awt.Color(255, 235, 205));
        ...
        solvebutt.setBackground(new java.awt.Color(51, 255, 51));
        solvebutt.setForeground(new java.awt.Color(0, 0, 0));
        ...
        getContentPane().add(solvebutt, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 130, 80, 50));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 260, 170, 80));

        denybutt.setBackground(new java.awt.Color(204, 0, 51));
        denybutt.setForeground(new java.awt.Color(0, 0, 0));
        denybutt.setText("no");
        ...
        getContentPane().add(denybutt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 130, 80, 50));

        allitalk.setForeground(new java.awt.Color(0, 0, 0));
        allitalk.setText("COME ON");
        getContentPane().add(allitalk, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 100, 160, -1));

        AlliFace.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/passportneutral.png"))); // NOI18N
        getContentPane().add(AlliFace, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 0, 170, 94));

        jButton3.setBackground(new java.awt.Color(255, 235, 205));
        jButton3.setForeground(new java.awt.Color(0, 0, 0));
        jButton3.setText("Get goin!");
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 190, 170, 60));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/table.png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -4, 810, 370));
    ...
    private void solvebuttActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_solvebuttActionPerformed
        ...
        allitalk.setText("Cool now lets get heading!");
        jButton3.setVisible(true);
        solvebutt.setVisible(false);
        denybutt.setVisible(false);
        // TODO add your handling code here:
